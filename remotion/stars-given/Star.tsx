...
/**
 * STAR COMPONENT - Flying star animation with GSAP
 *
 * Replicates GitHub Unwrapped star animation using GSAP instead of Spring
 */
export const Star: React.FC<{
  ...
  // GSAP-style distance animation (replaces Spring)
  ...
  // Extra scale on hit (impact effect)
